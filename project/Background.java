...
public class Background extends JPanel implements ActionListener{
	...
	File file1 = new File("./src/images/월요일.jpg");
	File file2 = new File("./src/images/화요일.jpg");
	File file3 = new File("./src/images/수요일.jpg");
	File file4 = new File("./src/images/목요일.jpg");
	File file5 = new File("./src/images/금요일.jpg");
	File file6 = new File("./src/images/토요일.jpg");
	File file7 = new File("./src/images/일요일.jpg");
	
	JButton dayStart = new JButton(new ImageIcon(Main.class.getResource("../images/dayStart.png")));
	JButton subjectA_1 = new JButton(new ImageIcon(Main.class.getResource("../images/과목A.png")));
	JButton subjectA_2 = new JButton(new ImageIcon(Main.class.getResource("../images/과목A.png")));
	JButton subjectA_3 = new JButton(new ImageIcon(Main.class.getResource("../images/과목A.png")));
	JButton subjectB_1 = new JButton(new ImageIcon(Main.class.getResource("../images/과목B.png")));
	JButton subjectB_2 = new JButton(new ImageIcon(Main.class.getResource("../images/과목B.png")));
	JButton subjectB_3 = new JButton(new ImageIcon(Main.class.getResource("../images/과목B.png")));
	JButton subjectC_1 = new JButton(new ImageIcon(Main.class.getResource("../images/과목C.png")));
	JButton subjectC_2 = new JButton(new ImageIcon(Main.class.getResource("../images/과목C.png")));
	JButton subjectC_3 = new JButton(new ImageIcon(Main.class.getResource("../images/과목C.png")));
	JButton breakTime_1 = new JButton(new ImageIcon(Main.class.getResource("../images/공강.png")));
	JButton breakTime_2 = new JButton(new ImageIcon(Main.class.getResource("../images/공강.png")));
	JButton breakTime_3 = new JButton(new ImageIcon(Main.class.getResource("../images/공강.png")));
	JButton fullBreakTime = new JButton(new ImageIcon(Main.class.getResource("../images/풀공강.png")));
