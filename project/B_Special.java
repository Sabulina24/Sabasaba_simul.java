...
public class B_Special extends JPanel implements ActionListener{
		...
		URL url_2 = getClass().getClassLoader().getResource("교수님방_B.jpg");
		...
		JButton up_special = new JButton(new ImageIcon(getClass().getClassLoader().getResource("호감도 상승_special.png")));
		JButton down_special = new JButton(new ImageIcon(getClass().getClassLoader().getResource("호감도 하락_special.png")));
		
		JButton c1_1 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_1_1.png")));
		JButton c1_2 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_1_2.png")));
		JButton c1_3 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_1_3.png")));
		JButton c2_1 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_2_1.png")));
		JButton c2_2 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_2_2.png")));
		JButton c2_3 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_2_3.png")));
		JButton c3_1 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_3_1.png")));
		JButton c3_2 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_3_2.png")));
		...
		private ImageIcon c1_1EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_1_1_clk.png"));
		private ImageIcon c1_1BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_1_1.png"));
		private ImageIcon c1_2EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_1_2_clk.png"));
		private ImageIcon c1_2BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_1_2.png"));
		private ImageIcon c1_3EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_1_3_clk.png"));
		private ImageIcon c1_3BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_1_3.png"));
		private ImageIcon c2_1EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_2_1_clk.png"));
		private ImageIcon c2_1BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_2_1.png"));
		private ImageIcon c2_2EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_2_2_clk.png"));
		private ImageIcon c2_2BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_2_2.png"));
		private ImageIcon c2_3EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_2_3_clk.png"));
		private ImageIcon c2_3BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_2_3.png"));
		private ImageIcon c3_1EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_3_1_clk.png"));
		private ImageIcon c3_1BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_3_1.png"));
		private ImageIcon c3_2EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_3_2_clk.png"));
		private ImageIcon c3_2BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_교수님방_3_2.png"));
