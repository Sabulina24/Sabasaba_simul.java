...
private static final long serialVersionUID = 1L;
	...
	URL url_2=getClass().getClassLoader().getResource("강의실복도_C.jpg");
	
	private ImageIcon select1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지3-1.png"));
	private ImageIcon selectc1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-1.png"));
	private ImageIcon select1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지3-2.png"));
	private ImageIcon selectc1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-2.png"));
	private ImageIcon select1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지3-3.png"));
	private ImageIcon selectc1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-3.png"));
	private ImageIcon select1_1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지3-1-1.png"));
	private ImageIcon selectc1_1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-1-1.png"));
	private ImageIcon select1_1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지3-1-2.png"));
	private ImageIcon selectc1_1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-1-2.png"));
	private ImageIcon select1_1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지3-1-3.png"));
	private ImageIcon selectc1_1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-1-3.png"));
	private ImageIcon select1_2_1=new ImageIcon(getClass().getClassLoader().getResource("선택지3-2-1.png"));
	private ImageIcon selectc1_2_1=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-2-1.png"));
	private ImageIcon select1_2_2=new ImageIcon(getClass().getClassLoader().getResource("선택지3-2-2.png"));
	private ImageIcon selectc1_2_2=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-2-2.png"));
	private ImageIcon select1_2_3=new ImageIcon(getClass().getClassLoader().getResource("선택지3-2-3.png"));
	private ImageIcon selectc1_2_3=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-2-3.png"));
	private ImageIcon select1_3_1=new ImageIcon(getClass().getClassLoader().getResource("선택지3-3-1.png"));
	private ImageIcon selectc1_3_1=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-3-1.png"));
	private ImageIcon select1_3_2=new ImageIcon(getClass().getClassLoader().getResource("선택지3-3-2.png"));
	private ImageIcon selectc1_3_2=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-3-2.png"));
	private ImageIcon select1_3_3=new ImageIcon(getClass().getClassLoader().getResource("선택지3-3-3.png"));
	private ImageIcon selectc1_3_3=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭3-3-3.png"));
