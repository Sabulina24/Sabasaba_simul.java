...
public class A_Holiday extends JPanel 
{
	...
	String[] d = ProfessorLines.getDialogue_A_Holiday();
    ...
    private ImageIcon button1Image=new ImageIcon(getClass().getClassLoader().getResource("3선택지1_1.png"));
    private ImageIcon button2Image=new ImageIcon(getClass().getClassLoader().getResource("3선택지1_2.png"));
   
    private ImageIcon button1ImageEntered=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭1_1.png"));
    private ImageIcon button2ImageEntered=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭1_2.png"));
    
    private ImageIcon button1ImageEntered2=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭1_1.png"));
    private ImageIcon button2ImageEntered2=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭1_2.png"));
    
    private ImageIcon button1_1Image=new ImageIcon(getClass().getClassLoader().getResource("3선택지2_1.png"));
    private ImageIcon button2_1Image=new ImageIcon(getClass().getClassLoader().getResource("3선택지2_2.png"));
    private ImageIcon button3_1Image=new ImageIcon(getClass().getClassLoader().getResource("3선택지2_3.png"));
    private ImageIcon button1_1ImageEntered=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭2_1.png"));
    private ImageIcon button2_1ImageEntered=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭2_2.png"));
    private ImageIcon button3_1ImageEntered=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭2_3.png"));
    
    private ImageIcon button1_1ImageEntered2=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭2_1.png"));
    private ImageIcon button2_1ImageEntered2=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭2_2.png"));
    private ImageIcon button3_1ImageEntered2=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭2_3.png"));
    
    private ImageIcon button1_2Image=new ImageIcon(getClass().getClassLoader().getResource("3선택지3_1.png"));
    private ImageIcon button2_2Image=new ImageIcon(getClass().getClassLoader().getResource("3선택지3_2.png"));
    private ImageIcon button3_2Image=new ImageIcon(getClass().getClassLoader().getResource("3선택지3_3.png"));
    private ImageIcon button1_2ImageEntered=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭3_1.png"));
    private ImageIcon button2_2ImageEntered=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭3_2.png"));
    private ImageIcon button3_2ImageEntered=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭3_3.png"));
    
    private ImageIcon button1_2ImageEntered2=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭3_1.png"));
    private ImageIcon button2_2ImageEntered2=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭3_2.png"));
    private ImageIcon button3_2ImageEntered2=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭3_3.png"));
    
    private ImageIcon button1_3Image=new ImageIcon(getClass().getClassLoader().getResource("3선택지4_1.png"));
    private ImageIcon button2_3Image=new ImageIcon(getClass().getClassLoader().getResource("3선택지4_2.png"));
   
    private ImageIcon button1_3ImageEntered=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭4_1.png"));
    private ImageIcon button2_3ImageEntered=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭4_2.png"));
   
    private ImageIcon button1_3ImageEntered2=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭4_1.png"));
    private ImageIcon button2_3ImageEntered2=new ImageIcon(getClass().getClassLoader().getResource("3선택지_클릭4_2.png"));
