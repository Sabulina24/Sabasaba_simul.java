		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(Meter<5&&DrinkingAlgorithm.Mood>=10) {
					...
					GoodFeeling.teacher1FeelUp(); //교수 a호감도 상승
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				else if(Meter>=15&&Meter<20)
				{
					...
					{
					lblNewLabel_2.setBounds(0, 0, 1280, 720);
					lblNewLabel_2.setIcon(new ImageIcon(profA.class.getResource("../images/lose1.png")));//지는 화면
					GoodFeeling.teacher1FeelDown(); //교수 a호감도 감소
