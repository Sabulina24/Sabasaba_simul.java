...
private static final long serialVersionUID = 1L;
	...
	private ImageIcon select1_1=new ImageIcon(Main.class.getResource("../images/선택지5-1.png"));

	private ImageIcon selectc1_1=new ImageIcon(Main.class.getResource("../images/선택지클릭5-1.png"));

	private ImageIcon select1_2=new ImageIcon(Main.class.getResource("../images/선택지5-2.png"));

	private ImageIcon selectc1_2=new ImageIcon(Main.class.getResource("../images/선택지클릭5-2.png"));

	private ImageIcon select1_3=new ImageIcon(Main.class.getResource("../images/선택지5-3.png"));

	private ImageIcon selectc1_3=new ImageIcon(Main.class.getResource("../images/선택지클릭5-3.png"));

	private ImageIcon select1_1_1=new ImageIcon(Main.class.getResource("../images/선택지5-1-1.png"));

	private ImageIcon selectc1_1_1=new ImageIcon(Main.class.getResource("../images/선택지클릭5-1-1.png"));

	private ImageIcon select1_1_2=new ImageIcon(Main.class.getResource("../images/선택지5-1-2.png"));

	private ImageIcon selectc1_1_2=new ImageIcon(Main.class.getResource("../images/선택지클릭5-1-2.png"));

	private ImageIcon select1_1_3=new ImageIcon(Main.class.getResource("../images/선택지5-1-3.png"));

	private ImageIcon selectc1_1_3=new ImageIcon(Main.class.getResource("../images/선택지클릭5-1-3.png"));

	private ImageIcon select1_2_1=new ImageIcon(Main.class.getResource("../images/선택지5-2-1.png"));

	private ImageIcon selectc1_2_1=new ImageIcon(Main.class.getResource("../images/선택지클릭5-2-1.png"));

	private ImageIcon select1_2_2=new ImageIcon(Main.class.getResource("../images/선택지5-2-2.png"));

	private ImageIcon selectc1_2_2=new ImageIcon(Main.class.getResource("../images/선택지클릭5-2-2.png"));

	private ImageIcon select1_2_3=new ImageIcon(Main.class.getResource("../images/선택지5-2-3.png"));

	private ImageIcon selectc1_2_3=new ImageIcon(Main.class.getResource("../images/선택지클릭5-2-3.png"));

	private ImageIcon select1_3_1=new ImageIcon(Main.class.getResource("../images/선택지5-3-1.png"));

	private ImageIcon selectc1_3_1=new ImageIcon(Main.class.getResource("../images/선택지클릭5-3-1.png"));

	private ImageIcon select1_3_2=new ImageIcon(Main.class.getResource("../images/선택지5-3-2.png"));

	private ImageIcon selectc1_3_2=new ImageIcon(Main.class.getResource("../images/선택지클릭5-3-2.png"));

	private ImageIcon select1_3_3=new ImageIcon(Main.class.getResource("../images/선택지5-3-3.png"));

	private ImageIcon selectc1_3_3=new ImageIcon(Main.class.getResource("../images/선택지클릭5-3-3.png"));
		...
		nextButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				try {
					...
					backGround=ImageIO.read(file6);//파일2로 바뀌면서 대화 발생
