...
public class A_Normal_2 extends JPanel{
	...
	private int t=0;
	private int k=0;
	private Image background=new ImageIcon(Main.class.getResource("../images/교수님방_A.jpg")).getImage();
   
    private JLabel label1= new JLabel("교수님 A");
    private JLabel label2= new JLabel(d[2*k]);
    private JLabel label3= new JLabel(d[2*k+1]);
    private JLabel downlabel=new JLabel(new ImageIcon(Main.class.getResource("../images/호감도 하락.png")));
    private JLabel uplabel=new JLabel(new ImageIcon(Main.class.getResource("../images/호감도 상승.png")));
  
	
    private ImageIcon exitbuttonBasicImage=new ImageIcon(Main.class.getResource("../images/images6.png"));
    private ImageIcon nextbuttonEntered=new ImageIcon(Main.class.getResource("../images/버튼1_클릭.png"));
    private ImageIcon nextbuttonbasic=new ImageIcon(Main.class.getResource("../images/버튼1.png"));
    
    private ImageIcon button1Image=new ImageIcon(Main.class.getResource("../images/2선택지1_1.png"));
    private ImageIcon button2Image=new ImageIcon(Main.class.getResource("../images/2선택지1_2.png"));
    private ImageIcon button3Image=new ImageIcon(Main.class.getResource("../images/2선택지1_3.png"));
    private ImageIcon button1ImageEntered=new ImageIcon(Main.class.getResource("../images/2선택지_클릭1_1.png"));
    private ImageIcon button2ImageEntered=new ImageIcon(Main.class.getResource("../images/2선택지_클릭1_2.png"));
    private ImageIcon button3ImageEntered=new ImageIcon(Main.class.getResource("../images/2선택지_클릭1_3.png"));
    
    private ImageIcon button1ImageEntered2=new ImageIcon(Main.class.getResource("../images/2선택지_클릭1_1.png"));
    private ImageIcon button2ImageEntered2=new ImageIcon(Main.class.getResource("../images/2선택지_클릭1_2.png"));
    private ImageIcon button3ImageEntered2=new ImageIcon(Main.class.getResource("../images/2선택지_클릭1_3.png"));
    
    private ImageIcon button1_1Image=new ImageIcon(Main.class.getResource("../images/2선택지2_1.png"));
    private ImageIcon button2_1Image=new ImageIcon(Main.class.getResource("../images/2선택지2_2.png"));
    private ImageIcon button3_1Image=new ImageIcon(Main.class.getResource("../images/2선택지2_3.png"));
    private ImageIcon button1_1ImageEntered=new ImageIcon(Main.class.getResource("../images/2선택지_클릭2_1.png"));
    private ImageIcon button2_1ImageEntered=new ImageIcon(Main.class.getResource("../images/2선택지_클릭2_2.png"));
    private ImageIcon button3_1ImageEntered=new ImageIcon(Main.class.getResource("../images/2선택지_클릭2_3.png"));
    
    private ImageIcon button1_1ImageEntered2=new ImageIcon(Main.class.getResource("../images/2선택지_클릭2_1.png"));
    private ImageIcon button2_1ImageEntered2=new ImageIcon(Main.class.getResource("../images/2선택지_클릭2_2.png"));
    private ImageIcon button3_1ImageEntered2=new ImageIcon(Main.class.getResource("../images/2선택지_클릭2_3.png"));
    
    private ImageIcon button1_2Image=new ImageIcon(Main.class.getResource("../images/2선택지3_1.png"));
    private ImageIcon button2_2Image=new ImageIcon(Main.class.getResource("../images/2선택지3_2.png"));
    private ImageIcon button3_2Image=new ImageIcon(Main.class.getResource("../images/2선택지3_3.png"));
    private ImageIcon button1_2ImageEntered=new ImageIcon(Main.class.getResource("../images/2선택지_클릭3_1.png"));
    private ImageIcon button2_2ImageEntered=new ImageIcon(Main.class.getResource("../images/2선택지_클릭3_2.png"));
    private ImageIcon button3_2ImageEntered=new ImageIcon(Main.class.getResource("../images/2선택지_클릭3_3.png"));
    
    private ImageIcon button1_2ImageEntered2=new ImageIcon(Main.class.getResource("../images/2선택지_클릭3_1.png"));
    private ImageIcon button2_2ImageEntered2=new ImageIcon(Main.class.getResource("../images/2선택지_클릭3_2.png"));
    private ImageIcon button3_2ImageEntered2=new ImageIcon(Main.class.getResource("../images/2선택지_클릭3_3.png"));
    
    private ImageIcon button1_3Image=new ImageIcon(Main.class.getResource("../images/2선택지4_1.png"));
    private ImageIcon button2_3Image=new ImageIcon(Main.class.getResource("../images/2선택지4_2.png"));
   
    private ImageIcon button1_3ImageEntered=new ImageIcon(Main.class.getResource("../images/2선택지_클릭4_1.png"));
    private ImageIcon button2_3ImageEntered=new ImageIcon(Main.class.getResource("../images/2선택지_클릭4_2.png"));
   
    
    private ImageIcon button1_3ImageEntered2=new ImageIcon(Main.class.getResource("../images/2선택지_클릭4_1.png"));
    private ImageIcon button2_3ImageEntered2=new ImageIcon(Main.class.getResource("../images/2선택지_클릭4_2.png"));
