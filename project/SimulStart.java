...
public class SimulStart extends JPanel {
	...
	private ImageIcon passButtonBasicImage=new ImageIcon(getClass().getClassLoader().getResource("버튼1.png"));
	private ImageIcon passButtonEnteredImage=new ImageIcon(getClass().getClassLoader().getResource("버튼1_클릭.png"));
	...
	public SimulStart() {	
		...
		super.add(me);
		me.setVisible(false);
		me.setFont(new Font("맑은 고딕", Font.BOLD, 30));

		sit1.setBounds(30, 480, 1200, 100);
		super.add(sit1);
		sit1.setVisible(false);
		sit1.setFont(new Font("맑은 고딕", Font.BOLD, 40));

		sit2.setBounds(30, 550, 1200, 100);
		super.add(sit2);
		sit2.setVisible(false);
		sit2.setFont(new Font("맑은 고딕", Font.BOLD, 40));
		...
		startButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				background=new ImageIcon(getClass().getClassLoader().getResource("backName.jpg")).getImage();//main으로 넘어옴						
	...
	public void introduce()	{
		...
		background=new ImageIcon(getClass().getClassLoader().getResource("교수님소개.jpg")).getImage();
	...
	public void Situation() {		
		...
		background=new ImageIcon(getClass().getClassLoader().getResource("강의실복도.jpg")).getImage();
