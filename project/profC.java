...
public class profC extends JPanel {
	...
	public profC() {
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				lblNewLabel.setIcon(new ImageIcon(profC.class.getResource("../images/\uC220\uC790\uB9AC(\uC548\uB9C8\uC2EC)_C.jpg")));
			}
		});
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(Meter<5)
					{
							lblNewLabel_1.setIcon(new ImageIcon(profC.class.getResource("../images/0-5.png")));
					...
					{
						lblNewLabel_1.setIcon(new ImageIcon(profC.class.getResource("../images/5-10.png")));
					...
					{
						lblNewLabel_1.setIcon(new ImageIcon(profC.class.getResource("../images/10-15.png")));
				...
				else if(Meter>=15&&Meter<20)
				{
					...
					lblNewLabel_1.setIcon(new ImageIcon(profC.class.getResource("../images/19.png")));
					
				
				}
				if(DrinkingAlgorithm.Mood<3)
					label_2.setIcon(new ImageIcon(profC.class.getResource("../images/19.png")));
						
				else if(DrinkingAlgorithm.Mood>=3&&DrinkingAlgorithm.Mood<6)
						
					label_2.setIcon(new ImageIcon(profC.class.getResource("../images/10-15.png")));
					
				else if(DrinkingAlgorithm.Mood>=6&&DrinkingAlgorithm.Mood<=9)
						
					label_2.setIcon(new ImageIcon(profC.class.getResource("../images/5-10.png")));
					
				else if(DrinkingAlgorithm.Mood>=10)
					label_2.setIcon(new ImageIcon(profC.class.getResource("../images/0-5.png")));
				
				if(Meter<5&&DrinkingAlgorithm.Mood>=10) {
					lblNewLabel_2.setBounds(0, 0, 1280, 720);
					lblNewLabel_2.setIcon(new ImageIcon(profC.class.getResource("../images/win1.png")));
					GoodFeeling.teacher3FeelUp(); //교수 c호감도 상승
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(Meter<5)
					{
							lblNewLabel.setIcon(new ImageIcon(profC.class.getResource("../images/\uC220\uC790\uB9AC(\uB9C8\uC2EC)_C.jpg")));
							lblNewLabel_1.setIcon(new ImageIcon(profC.class.getResource("../images/0-5.png")));
				...
				else if(Meter>=15&&Meter<20)
				{
					...
					{
					lblNewLabel_2.setBounds(0, 0, 1280, 720);
					lblNewLabel_2.setIcon(new ImageIcon(profC.class.getResource("../images/lose1.png")));//지는 화면
					GoodFeeling.teacher3FeelDown(); //교수 c호감도 감소
		...
		btnNewButton_1.setIcon(new ImageIcon(profC.class.getResource("../images/\uD5DB\uAC1C\uC218_2.jpg")));
