...
public class profC extends JPanel {
	...
	public profC() {
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				lblNewLabel.setIcon(new ImageIcon(getClass().getClassLoader().getResource("\uC220\uC790\uB9AC(\uC548\uB9C8\uC2EC)_C.jpg")));
			}
		});
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(Meter<5)
					{
							lblNewLabel.setIcon(new ImageIcon(getClass().getClassLoader().getResource("\uC220\uC790\uB9AC(\uB9C8\uC2EC)_C.jpg")));
							lblNewLabel_1.setIcon(new ImageIcon(getClass().getClassLoader().getResource("0-5.png")));
