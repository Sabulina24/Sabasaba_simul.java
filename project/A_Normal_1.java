...
public class A_Normal_1 extends JPanel 
{
	...
	String[] d = ProfessorDialogue.getDialogue_A_Normal1();
	private int i=0;
	private int t=0;
	private int k=0;
    ...
    private ImageIcon button1Image=new ImageIcon(Main.class.getResource("../images/선택지1번 .png"));
    private ImageIcon button2Image=new ImageIcon(Main.class.getResource("../images/선택지2.png"));
    
    private ImageIcon button1ImageEntered=new ImageIcon(Main.class.getResource("../images/선택지1클릭.png"));
    private ImageIcon button2ImageEntered=new ImageIcon(Main.class.getResource("../images/선택지2클릭.png"));
    
    private ImageIcon button1ImageEntered2=new ImageIcon(Main.class.getResource("../images/선택지1클릭.png"));
    private ImageIcon button2ImageEntered2=new ImageIcon(Main.class.getResource("../images/선택지2클릭.png"));
    
    
    private ImageIcon button1_1Image=new ImageIcon(Main.class.getResource("../images/선택지1_1.png"));
    private ImageIcon button2_1Image=new ImageIcon(Main.class.getResource("../images/선택지2_1.png"));
    private ImageIcon button3_1Image=new ImageIcon(Main.class.getResource("../images/선택지3_1.png"));
    private ImageIcon button1_1ImageEntered=new ImageIcon(Main.class.getResource("../images/선택지_클릭1_1.png"));
    private ImageIcon button2_1ImageEntered=new ImageIcon(Main.class.getResource("../images/선택지_클릭2_1.png"));
    private ImageIcon button3_1ImageEntered=new ImageIcon(Main.class.getResource("../images/선택지_클릭3_1.png"));
    
    private ImageIcon button1_1ImageEntered2=new ImageIcon(Main.class.getResource("../images/선택지_클릭1_1.png"));
    private ImageIcon button2_1ImageEntered2=new ImageIcon(Main.class.getResource("../images/선택지_클릭2_1.png"));
    private ImageIcon button3_1ImageEntered2=new ImageIcon(Main.class.getResource("../images/선택지_클릭3_1.png"));
    
    private ImageIcon button1_2Image=new ImageIcon(Main.class.getResource("../images/선택지1_2.png"));
    private ImageIcon button2_2Image=new ImageIcon(Main.class.getResource("../images/선택지2_2.png"));
    private ImageIcon button3_2Image=new ImageIcon(Main.class.getResource("../images/선택지3_2.png"));
    private ImageIcon button1_2ImageEntered=new ImageIcon(Main.class.getResource("../images/선택지_클릭1_2.png"));
    private ImageIcon button2_2ImageEntered=new ImageIcon(Main.class.getResource("../images/선택지_클릭2_2.png"));
    private ImageIcon button3_2ImageEntered=new ImageIcon(Main.class.getResource("../images/선택지_클릭3_2.png"));
    
    private ImageIcon button1_2ImageEntered2=new ImageIcon(Main.class.getResource("../images/선택지_클릭1_2.png"));
    private ImageIcon button2_2ImageEntered2=new ImageIcon(Main.class.getResource("../images/선택지_클릭2_2.png"));
    private ImageIcon button3_2ImageEntered2=new ImageIcon(Main.class.getResource("../images/선택지_클릭3_2.png"));
