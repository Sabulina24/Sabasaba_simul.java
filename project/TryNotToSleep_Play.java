...
public class TryNotToSleep_Play extends JPanel implements ActionListener{
	...
	public void paint(Graphics g) {
		...
		g.fillRect(0, SleepingAlgorithm.DrousyMeter-900, 1280, 900); //윗 눈꺼풀
		g.fillRect(0, 700-SleepingAlgorithm.DrousyMeter, 1280, 900); // 밑 눈꺼풀
		g.setColor(Color.red);
		g.fillRect(308,267,tiredMeter*2,47);//피로도
		tm.start(); //타이머,ActionListner 시작
	}
