...
public class C_Holiday extends JPanel{
	...
	URL url_7=getClass().getClassLoader().getResource("캠퍼스.jpg");
	URL url_8=getClass().getClassLoader().getResource("캠퍼스_C.jpg");
	
	private ImageIcon select1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지4-1.png"));
	private ImageIcon selectc1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭4-1.png"));
	private ImageIcon select1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지4-2.png"));
	private ImageIcon selectc1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭4-2.png"));
	private ImageIcon select1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지4-3.png"));
	private ImageIcon selectc1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭4-3.png"));
	private ImageIcon select1_1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지4-1-1.png"));
	private ImageIcon selectc1_1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭4-1-1.png"));
	private ImageIcon select1_1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지4-1-2.png"));
	private ImageIcon selectc1_1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭4-1-2.png"));
	private ImageIcon select1_1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지4-1-3.png"));
	private ImageIcon selectc1_1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭4-1-3.png"));
	private ImageIcon select1_3_1=new ImageIcon(getClass().getClassLoader().getResource("선택지4-3-1.png"));
	private ImageIcon selectc1_3_1=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭4-3-1.png"));
	private ImageIcon select1_3_2=new ImageIcon(getClass().getClassLoader().getResource("선택지4-3-2.png"));
	private ImageIcon selectc1_3_2=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭4-3-2.png"));
	private ImageIcon select1_3_3=new ImageIcon(getClass().getClassLoader().getResource("선택지4-3-3.png"));
	private ImageIcon selectc1_3_3=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭4-3-3.png"));
	...
	public C_Holiday(){
		...
		nextButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				try {
					backGround=ImageIO.read(url_8);//파일2로 바뀌면서 대화 발생
				}catch(IOException ex) {
					ex.printStackTrace();
				}
				repaint();	
