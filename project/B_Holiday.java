...
public class B_Holiday extends JPanel implements ActionListener{
	...
	JButton c1_1 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_1_1.png")));
	JButton c1_2 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_1_2.png")));
	JButton c1_3 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_1_3.png")));
	JButton c2_1 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_2_1.png")));
	JButton c2_2 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_2_2.png")));
	JButton c2_3 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_2_3.png")));
	JButton c3_1 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1.png")));
	JButton c3_2 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_2.png")));
	JButton c3_3 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_3.png")));
	JButton c3_1_1 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1_1.png")));
	JButton c3_1_2 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1_2.png")));
	JButton c3_1_3 = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1_3.png")));
	JButton doIt = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_도전.png")));
	JButton notDoIt = new JButton(new ImageIcon(getClass().getClassLoader().getResource("선택지_도전안함.png")));
	...
	private ImageIcon c1_1EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_1_1_clk.png"));
	private ImageIcon c1_1BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_1_1.png"));
	private ImageIcon c1_2EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_1_2_clk.png"));
	private ImageIcon c1_2BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_1_2.png"));
	private ImageIcon c1_3EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_1_3_clk.png"));
	private ImageIcon c1_3BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_1_3.png"));
	private ImageIcon c2_1EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_2_1_clk.png"));
	private ImageIcon c2_1BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_2_1.png"));
	private ImageIcon c2_2EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_2_2_clk.png"));
	private ImageIcon c2_2BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_2_2.png"));
	private ImageIcon c2_3EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_2_3_clk.png"));
	private ImageIcon c2_3BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_2_3.png"));
	private ImageIcon c3_1EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1_clk.png"));
	private ImageIcon c3_1BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1.png"));
	private ImageIcon c3_2EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_2_clk.png"));
	private ImageIcon c3_2BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_2.png"));
	private ImageIcon c3_3EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_3_clk.png"));
	private ImageIcon c3_3BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_3.png"));
	private ImageIcon c3_1_1EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1_1_clk.png"));
	private ImageIcon c3_1_1BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1_1.png"));
	private ImageIcon c3_1_2EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1_2_clk.png"));
	private ImageIcon c3_1_2BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1_2.png"));
	private ImageIcon c3_1_3EnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1_3_clk.png"));
	private ImageIcon c3_1_3BasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_휴일_3_1_3.png"));
	private ImageIcon doItEnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_도전_clk.png"));
	private ImageIcon doItBasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_도전.png"));
	private ImageIcon notDoItEnteredImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_도전안함_clk.png"));
	private ImageIcon notDoItBasicImage = new ImageIcon(getClass().getClassLoader().getResource("선택지_도전안함.png"));
