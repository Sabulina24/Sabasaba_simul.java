...
private static final long serialVersionUID = 1L;
	...
	private ImageIcon select1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지1-1.png"));
	private ImageIcon selectc1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-1.png"));
	private ImageIcon select1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지1-2.png"));
	private ImageIcon selectc1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-2.png"));
	private ImageIcon select1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지1-3.png"));
	private ImageIcon selectc1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-3.png"));
	private ImageIcon select1_1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지1-1-1.png"));
	private ImageIcon selectc1_1_1=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-1-1.png"));
	private ImageIcon select1_1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지1-1-2.png"));
	private ImageIcon selectc1_1_2=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-1-2.png"));
	private ImageIcon select1_1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지1-1-3.png"));
	private ImageIcon selectc1_1_3=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-1-3.png"));
	private ImageIcon select1_2_1=new ImageIcon(getClass().getClassLoader().getResource("선택지1-2-1.png"));
	private ImageIcon selectc1_2_1=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-2-1.png"));
	private ImageIcon select1_2_2=new ImageIcon(getClass().getClassLoader().getResource("선택지1-2-2.png"));
	private ImageIcon selectc1_2_2=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-2-2.png"));
	private ImageIcon select1_2_3=new ImageIcon(getClass().getClassLoader().getResource("선택지1-2-3.png"));
	private ImageIcon selectc1_2_3=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-2-3.png"));
	private ImageIcon select1_3_1=new ImageIcon(getClass().getClassLoader().getResource("선택지1-3-1.png"));
	private ImageIcon selectc1_3_1=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-3-1.png"));
	private ImageIcon select1_3_2=new ImageIcon(getClass().getClassLoader().getResource("선택지1-3-2.png"));
	private ImageIcon selectc1_3_2=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-3-2.png"));
	private ImageIcon select1_3_3=new ImageIcon(getClass().getClassLoader().getResource("선택지1-3-3.png"));
	private ImageIcon selectc1_3_3=new ImageIcon(getClass().getClassLoader().getResource("선택지클릭1-3-3.png"));
